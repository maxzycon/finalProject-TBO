...
prep = "Prep | di | kepada | pada | saat | dengan | di | jika | pada | dari | untuk | atas | kepada | terhadap | ke | pada | dalam | di | dari | dekat | ketika | sehingga | yang | karena | sejak | dengan | sejak | dalam | dengan | di | jika | pada | dari | saat | untuk | atas | kepada | terhadap | ke | pada | dalam | di | dari | karena | untuk"
